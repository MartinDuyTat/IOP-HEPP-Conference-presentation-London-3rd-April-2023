...
\begin{frame}[fragile]{Sensitivity through interference}
  \begin{center}
    ...
    Interference depends on $\gamma$, diluted by $\kappa$ when integrated over phase space
  \end{center}
  \begin{equation*}
...
\begin{frame}{Phase space binned analysis of $B^\pm\to[K^+K^-\pi^+\pi^-]_DK^\pm$}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item{Phys. Lett. \textbf{B647} (2007) 400 by J. Rademacker and G. Wilkinson}
    ...
    \end{itemize}
    \item{Use LHCb model to identify regions with large asymmetries}
    \begin{itemize}
...
\begin{frame}{Phase space binned analysis of $B^\pm\to[K^+K^-\pi^+\pi^-]_DK^\pm$}
  ...
  \begin{itemize}
    ...
    \item{The amplitude-averaged cosine and sine of $\delta_D$, $c_i$ and $s_i$, are measured directly in each bin at charm factories}
  \end{itemize}
\end{frame}
