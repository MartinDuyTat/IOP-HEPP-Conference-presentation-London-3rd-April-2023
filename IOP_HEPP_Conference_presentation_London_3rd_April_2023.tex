...
\begin{frame}{First look at $B^\pm\to[K^+K^-\pi^+\pi^-]_DK^\pm$}
  ...
  \vspace{-0.5cm}
  \begin{center}
    {\large Measuring the $B^\pm\to DK^\pm$ asymmetry $\mathcal{A}$ provides useful constraints on $\gamma$, but with some caveats:}
  \end{center}
  \begin{enumerate}
      ...
      \begin{figure}[H]
        ...
        \begin{fmffile}{fgraph/fgraph_D2rhophi}
          ...
          \begin{fmfgraph*}(6,4)
            ...
            \fmfv{decor.shape=circle,decor.filled=shaded,decor.size=0.15w,label=\footnotesize$\phi(1020)$,label.angle=110,label.dist=1.1cm}{v1}
            \fmf{plain}{v1,o1}
            \fmf{plain}{v1,o2}
            \fmf{plain,tension=1.5}{i1,v2}
            \fmfv{decor.shape=circle,decor.filled=shaded,decor.size=0.15w,label=\footnotesize$\rho^0$,label.angle=-110,label.dist=1.0cm}{v2}
            \fmf{plain}{v2,o3}
            \fmf{plain}{v2,o4}
          \end{fmfgraph*}
        \end{fmffile}
